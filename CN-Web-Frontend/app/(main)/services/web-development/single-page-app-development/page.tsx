...
export default function SinglePageAppDevelopmentPage() {
  const hero = {
    ...heroProps,
    topBadge: { ...heroProps.topBadge, icon: <Code2 className="w-4 h-4 text-[#4EB3E8]" /> },
    bottomBadge: { ...heroProps.bottomBadge, icon: <Zap className="w-4 h-4 text-emerald-500" /> },
  };
