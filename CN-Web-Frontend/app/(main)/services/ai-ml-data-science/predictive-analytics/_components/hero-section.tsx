...
import { ArrowRight, ArrowLeft, BarChart3, TrendingUp } from "lucide-react";
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            >
              Predictive
              <br />
              <span className="text-[#4EB3E8]">Analytics</span>
            </h1>
            ...
            >
              Turn historical signals into forward-looking guidance - forecasting, scoring, and
              monitoring designed for operators and executives.
            </p>
...
function HeroImage() {
  return (
    ...
    >
      ...
      <FloatingBadge
        icon={<BarChart3 className="w-4 h-4 text-[#4EB3E8]" />}
        title="Forecasting"
