...
export default function SaasMobileSolutionsPage() {
  const hero = {
    ...heroProps,
    topBadge: { ...heroProps.topBadge, icon: <Smartphone className="w-4 h-4 text-[#4EB3E8]" /> },
    bottomBadge: { ...heroProps.bottomBadge, icon: <Layers className="w-4 h-4 text-emerald-500" /> },
  };
