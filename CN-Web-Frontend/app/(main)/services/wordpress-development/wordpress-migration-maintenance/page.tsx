...
export default function WordpressMigrationMaintenancePage() {
  const hero = {
    ...heroProps,
    topBadge: { ...heroProps.topBadge, icon: <Rocket className="w-4 h-4 text-[#4EB3E8]" /> },
    bottomBadge: { ...heroProps.bottomBadge, icon: <ShieldCheck className="w-4 h-4 text-emerald-500" /> },
  };
