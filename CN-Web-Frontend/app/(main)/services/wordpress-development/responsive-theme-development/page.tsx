...
export default function ResponsiveThemeDevelopmentPage() {
  const hero = {
    ...heroProps,
    topBadge: { ...heroProps.topBadge, icon: <Palette className="w-4 h-4 text-[#4EB3E8]" /> },
    bottomBadge: { ...heroProps.bottomBadge, icon: <Code2 className="w-4 h-4 text-emerald-500" /> },
  };
