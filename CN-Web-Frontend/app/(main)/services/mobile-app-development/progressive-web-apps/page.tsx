...
export default function ProgressiveWebAppsPage() {
  const hero = {
    ...heroProps,
    topBadge: { ...heroProps.topBadge, icon: <Globe2 className="w-4 h-4 text-[#4EB3E8]" /> },
    bottomBadge: { ...heroProps.bottomBadge, icon: <WifiOff className="w-4 h-4 text-emerald-500" /> },
  };
