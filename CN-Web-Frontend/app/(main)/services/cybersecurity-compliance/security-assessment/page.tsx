...
export default function SecurityAssessmentPage() {
  const hero = {
    ...heroProps,
    topBadge: { ...heroProps.topBadge, icon: <ClipboardList className="w-4 h-4 text-[#4EB3E8]" /> },
    bottomBadge: { ...heroProps.bottomBadge, icon: <CheckCircle2 className="w-4 h-4 text-emerald-500" /> },
  };
